package com.zc.learn.shop.utils.id;

import com.zc.learn.shop.utils.id.SnowFlake;
...
public class SnowFlakeFactory {
    ...
    public static SnowFlake getSnowFlake(long datacenterId, long machinedId){
        return new SnowFlake(datacenterId, machinedId);
    }
